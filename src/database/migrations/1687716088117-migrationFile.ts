...
export class MigrationFile1687716088117 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "user_profile" ADD CONSTRAINT "FK_380944e25224bc584e658d6cf91" FOREIGN KEY ("avatarId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user_profile" DROP CONSTRAINT "FK_380944e25224bc584e658d6cf91"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."user_device_installationsource_enum"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."user_device_operationsystem_enum"`,
    );
    await queryRunner.query(
